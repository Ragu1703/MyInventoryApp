...
public class ProductListActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.ragu.naveen.ark.myinventoryapp.R.layout.activity_main);

        FloatingActionButton fab = (FloatingActionButton) findViewById(com.ragu.naveen.myinventoryapp.R.id.fab);
        ...
        ListView productListView = (ListView) findViewById(com.ragu.naveen.myinventoryapp.R.id.list);

        View emptyView = findViewById(com.ragu.naveen.myinventoryapp.R.id.empty_view);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(ragu.example.ark.myinventoryapp.R.menu.menu_main, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case ragu.example.ark.myinventoryapp.R.id.action_insert_dummy_data:
                insertProduct();
                return true;
            case ragu.example.ark.myinventoryapp.R.id.action_delete_all_entries:
                deleteAllProducts();
                return true;
        }
