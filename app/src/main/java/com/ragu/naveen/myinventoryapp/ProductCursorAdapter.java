...
public class ProductCursorAdapter extends CursorAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        return LayoutInflater.from(context).inflate(com.habit.ark.myinventoryapp.R.layout.list_item, parent, false);
    }
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        TextView nameTextView = (TextView) view.findViewById(com.habit.ark.myinventoryapp.R.id.name);
        TextView priceTextView = (TextView) view.findViewById(com.habit.ark.myinventoryapp.R.id.price);
        final TextView quantityTextView = (TextView) view.findViewById(com.habit.ark.myinventoryapp.R.id.quantity);
        ...
        if (TextUtils.isEmpty(productName)) {
            productName = context.getString(com.habit.ark.myinventoryapp.R.string.unknown_product);
        }
        ...
        Button sellButton = (Button) view.findViewById(com.habit.ark.myinventoryapp.R.id.button_sell);
