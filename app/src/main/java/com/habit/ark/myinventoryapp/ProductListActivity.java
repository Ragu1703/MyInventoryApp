...
public class ProductListActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void insertProduct() {
        ...
        values.put(ProductContract.ProductEntry.COLUMN_SELLER_NO, "9898989898");
        values.put(ProductContract.ProductEntry.COLUMN_VERSION,5);
        values.put(ProductContract.ProductEntry.COLUMN_MFG_DATE,2013);
