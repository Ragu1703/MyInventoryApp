...
import com.habit.ark.myinventoryapp.data.ProductContract;
...
public class ProductEditActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private EditText mInputversion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextView = (TextView) findViewById(R.id.sel);
        ...
        if (mCurrentProductUri == null) {
            ...
            Button orderMore = (Button) findViewById(R.id.action_save);
        ...
        mInputCellnbr = (EditText) findViewById(R.id.phno);
        addQuantity = (Button) findViewById(R.id.increment_quantity);
        sellQuantity = (Button) findViewById(R.id.decrement_quantity);
        mInputdate=(EditText) findViewById(R.id.date);
        mInputversion=(EditText) findViewById(R.id.version);
        ...
        mInputdate.setOnTouchListener(mTouchListener);
        mInputversion.setOnTouchListener(mTouchListener);
    ...
    private void saveProduct() {
        ...
        String mfgString=mInputdate.getText().toString().trim();
        String versionString=mInputversion.getText().toString().trim();
        if (mCurrentProductUri == null &&
        ...
        values.put(ProductContract.ProductEntry.COLUMN_SELLER_NO, contactString);
        values.put(ProductContract.ProductEntry.COLUMN_MFG_DATE, mfgString);
        values.put(ProductContract.ProductEntry.COLUMN_VERSION, versionString);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        String[] projection = {
                ...
                ProductContract.ProductEntry.COLUMN_SELLER_NO,
                ProductContract.ProductEntry.COLUMN_VERSION,
                ProductContract.ProductEntry.COLUMN_MFG_DATE};
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int contactColumnIndex = cursor.getColumnIndex(ProductContract.ProductEntry.COLUMN_SELLER_NO);
